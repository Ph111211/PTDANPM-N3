        ...
        @foreach ($giangviens as $giangvien)
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-sm  btn-info my-3" data-id="{{ $giangvien->user_id }}" data-toggle="modal" data-target="#deleteModal">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form id="deleteForm" method="POST" action="{{ route('users.destroy', $giangvien->user_id) }}">
                                        @csrf
                                        @method('DELETE')
                    ...
                    <script>
                        $(document).ready(function() {
                            $('.btn-delete').on('click', function() {
                                var id = $(this).data('id');
                                $('#deleteForm').attr('action', '/giangvien/' + id + '/xoa');
                            });
                        });
                    </script>
