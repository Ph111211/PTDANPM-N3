...
<body>
    ...
    <form action="{{ route('giangvien/quanlysinhvien.store') }}" method="POST">
        @csrf
        <div class="mb-3">
        ...
        <div class="d-flex">
            <a href="{{ route('giangvien/quanlysinhvien.index') }}" class="btn border-danger text-danger my-4">Hủy</a>
