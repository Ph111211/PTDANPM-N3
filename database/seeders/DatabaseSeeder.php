...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('users')->insert([
            ['id' => 1, 'name' => 'Nguyễn Văn An', 'email' => 'nguyenvana@university.edu', 'password' => Hash::make('password')],
            ['id' => 2, 'name' => 'Trần Thị Bắc', 'email' => 'tranthib@university.edu', 'password' => Hash::make('password')],
            ['id' => 3, 'name' => 'Lê Văn Cao', 'email' => 'levanc@university.edu', 'password' => Hash::make('password')],
            ['id' => 4, 'name' => 'Phạm Minh Dương', 'email' => 'phamminhd@university.edu', 'password' => Hash::make('password')],
            ['id' => 5, 'name' => 'Hoàng Thu Hoa', 'email' => 'hoangthue@university.edu', 'password' => Hash::make('password')],
            ['id' => 6, 'name' => 'Đặng Quốc Đăng', 'email' => 'dangquocf@university.edu', 'password' => Hash::make('password')],
            ['id' => 7, 'name' => 'Vũ Hải Giang', 'email' => 'vuhai@university.edu', 'password' => Hash::make('password')],
            ['id' => 8, 'name' => 'Bùi Thanh Huyền', 'email' => 'buithanhh@university.edu', 'password' => Hash::make('password')],
            ['id' => 9, 'name' => 'Phan Minh Khôi', 'email' => 'pmk@example.com', 'password' => Hash::make('password')],
            ['id' => 10, 'name' => 'Nguyễn Thảo Vy', 'email' => 'ntv@example.com', 'password' => Hash::make('password')],
            ['id' => 11, 'name' => 'Trần Hữu Phước', 'email' => 'thp@example.com', 'password' => Hash::make('password')],
            ['id' => 12, 'name' => 'Lê Quỳnh Anh', 'email' => 'lqa@example.com', 'password' => Hash::make('password')],
            ['id' => 13, 'name' => 'Vũ Đình Bảo', 'email' => 'vdb@example.com', 'password' => Hash::make('password')],
        ]);
